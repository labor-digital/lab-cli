...
exports.InstallCaCommand = void 0;
const ElevatedProcess_1 = require("../Api/ElevatedProcess");
class InstallCaCommand {
    /**
    ...
    execute(run, context, stack, otherArgs) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            (new ElevatedProcess_1.ElevatedProcess(context)).exec(command);
            return context;
        });
    }
}
exports.InstallCaCommand = InstallCaCommand;
//# sourceMappingURL=InstallCaCommand.js.map
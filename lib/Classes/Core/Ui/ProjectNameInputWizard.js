...
exports.ProjectNameInputWizard = void 0;
/*
...
class ProjectNameInputWizard {
    /**
     * Asks the user for the project name and generates it based on multiple options
     */
    static run(initialQuestion, context, defaultName, acceptDefaults = false) {
        if (defaultName) {
            ...
            inquirer_1.default.prompt([
                ...
                if (answers.projectNameInputType === 'wizard') {
                    ...
                    while (parts.length < 3) {
                        ...
                        if (typeof part === 'undefined') {
                            return reject('Could not read project name by directory, because the path is to short!');
                        }
                        parts.push(ProjectNameInputWizard.wizardInputFilter(part));
                    }
     ...
     * @param input
     */
    static wizardInputFilter(input) {
     ...
     * @param input
     */
    static wizardInputValidate(input) {
        if (input.length === 0) {
            return 'The input can\'t be empty!';
        }
        if (input.replace(/[^0-9_\-a-z]/g, '') !==
...
exports.ProjectNameInputWizard = ProjectNameInputWizard;
//# sourceMappingURL=ProjectNameInputWizard.js.map
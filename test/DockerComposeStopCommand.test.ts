import { DockerComposeStopCommand } from '../src/Classes/Command/DockerComposeStopCommand';
...
describe('DockerComposeStopCommand', () => {
    let command: DockerComposeStopCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerComposeStopCommand();

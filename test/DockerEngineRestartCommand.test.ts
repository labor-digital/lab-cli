import { DockerEngineRestartCommand } from '../src/Classes/Command/DockerEngineRestartCommand';
...
describe('DockerEngineRestartCommand', () => {
    let command: DockerEngineRestartCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerEngineRestartCommand();

import { DockerComposeShellCommand } from '../src/Classes/Command/DockerComposeShellCommand';
...
describe('DockerComposeShellCommand', () => {
    let command: DockerComposeShellCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerComposeShellCommand();

import { DockerComposeUnisonCommand } from '../src/Classes/Command/DockerComposeUnisonCommand';
...
describe('DockerComposeUnisonCommand', () => {
    let command: DockerComposeUnisonCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerComposeUnisonCommand();

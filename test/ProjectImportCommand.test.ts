import { ProjectImportCommand } from '../src/Classes/Command/ProjectImportCommand';
...
describe('ProjectImportCommand', () => {
    let command: ProjectImportCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new ProjectImportCommand();

import { InstallCaCommand } from '../src/Classes/Command/InstallCaCommand';
...
describe('InstallCaCommand', () => {
    let command: InstallCaCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    it('should execute successfully', async () => {
        ...
        try {
            await command.execute('run', mockContext as AppContext, mockStack as CommandStack, []);
        } catch (e) {

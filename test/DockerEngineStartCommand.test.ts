import { DockerEngineStartCommand } from '../src/Classes/Command/DockerEngineStartCommand';
...
describe('DockerEngineStartCommand', () => {
    let command: DockerEngineStartCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerEngineStartCommand();

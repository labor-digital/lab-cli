import { DockerComposeLogsCommand } from '../src/Classes/Command/DockerComposeLogsCommand';
...
describe('DockerComposeLogsCommand', () => {
    let command: DockerComposeLogsCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerComposeLogsCommand();

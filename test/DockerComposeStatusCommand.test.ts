import { DockerComposeStatusCommand } from '../src/Classes/Command/DockerComposeStatusCommand';
...
describe('DockerComposeStatusCommand', () => {
    let command: DockerComposeStatusCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerComposeStatusCommand();

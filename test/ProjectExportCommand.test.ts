import { ProjectExportCommand } from '../src/Classes/Command/ProjectExportCommand';
...
describe('ProjectExportCommand', () => {
    let command: ProjectExportCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new ProjectExportCommand();
    ...
    it('should execute successfully', async () => {
        ...
        try {
            await command.execute(mockCmd as Command, mockContext as AppContext, mockStack as CommandStack);
        } catch (e) {

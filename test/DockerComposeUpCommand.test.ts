import { DockerComposeUpCommand } from '../src/Classes/Command/DockerComposeUpCommand';
...
describe('DockerComposeUpCommand', () => {
    let command: DockerComposeUpCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerComposeUpCommand();

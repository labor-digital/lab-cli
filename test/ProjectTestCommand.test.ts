import { ProjectTestCommand } from '../src/Classes/Command/ProjectTestCommand';
...
describe('ProjectTestCommand', () => {
    let command: ProjectTestCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new ProjectTestCommand();

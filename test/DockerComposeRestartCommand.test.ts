import { DockerComposeRestartCommand } from '../src/Classes/Command/DockerComposeRestartCommand';
...
describe('DockerComposeRestartCommand', () => {
    let command: DockerComposeRestartCommand;
    let mockCmd: any;
    let mockContext: any;
    let mockStack: any;
    ...
    beforeEach(() => {
        ...
        command = new DockerComposeRestartCommand();
